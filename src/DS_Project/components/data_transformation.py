...
from src.DS_Project.utils import save_obj
...
class DataTransformation:
        ...
        # this function is responsible for data transformation
         try:
            ...
            preprocessor = ColumnTransformer(
                [
                    ("nums_pipeline",num_pipeline,numerical_columns),
    ...
    def initiate_data_transormation(self, train_path, test_path):
        try:
            ...
            # train_df['test_preparation _course'].head(5);
            ...
            input_features_train_df=train_df[['gender', 'race_ethnicity', 'parental_level_education', 'lunch', 'test_preparation _course', 'writing_score', 'reading_score']]
            ...
            test_arr = np.c_[input_feature_test_arr, target_features_test_df]
